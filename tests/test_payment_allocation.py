...
class TestPaymentAllocationList:
    def test_list_allocations_empty(self, client):
    ...
    def test_list_allocations_with_data(self, client, db_helpers):
...
class TestPaymentAllocationCreate:
    def test_create_allocation(self, client, db_helpers):
        school = db_helpers.create_school()
        student = db_helpers.create_student(school)
        invoice = db_helpers.create_invoice(student, invoice_number="INV-001")
        payment = db_helpers.create_payment(student)
    ...
    def test_create_allocation_payment_not_found(self, client, db_helpers):
        school = db_helpers.create_school()
        student = db_helpers.create_student(school)
    ...
    def test_create_allocation_invoice_not_found(self, client, db_helpers):
        school = db_helpers.create_school()
        student = db_helpers.create_student(school)
        payment = db_helpers.create_payment(student)
        allocation_data = {
...
class TestPaymentAllocationGet:
    def test_get_allocation(self, client, db_helpers):
        school = db_helpers.create_school()
        student = db_helpers.create_student(school)
        invoice = db_helpers.create_invoice(student)
        payment = db_helpers.create_payment(student)
        ...
        response = client.get(f"/payment-allocation/{allocation.id}")
    ...
    def test_get_allocation_not_found(self, client):
...
class TestPaymentAllocationUpdate:
    def test_update_allocation(self, client, db_helpers):
        school = db_helpers.create_school()
        student = db_helpers.create_student(school)
        invoice = db_helpers.create_invoice(student)
        payment = db_helpers.create_payment(student)
        ...
        response = client.put(f"/payment-allocation/{allocation.id}", json=update_data)
    ...
    def test_update_allocation_not_found(self, client):
...
class TestPaymentAllocationDelete:
    def test_delete_allocation(self, client, db_helpers):
        school = db_helpers.create_school()
        student = db_helpers.create_student(school)
        invoice = db_helpers.create_invoice(student)
        payment = db_helpers.create_payment(student)
...
class TestPaymentAllocationInvoiceStatus:
    def test_allocation_updates_invoice_status_to_partially_paid(self, client, db_helpers):
    ...
    def test_allocation_updates_invoice_status_to_paid(self, client, db_helpers):
    ...
    def test_multiple_allocations_sum_to_paid(self, client, db_helpers):
    ...
    def test_pending_payment_not_counted_for_invoice_status(self, client, db_helpers):
    ...
    def test_overpayment_still_marks_as_paid(self, client, db_helpers):
        """When allocation exceeds invoice amount, status still becomes paid."""
        school = db_helpers.create_school()
        student = db_helpers.create_student(school)
        invoice = db_helpers.create_invoice(
            student, invoice_number="INV-001", amount_in_cents=10000, status=InvoiceStatus.PENDING.value
